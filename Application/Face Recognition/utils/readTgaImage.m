...
Author:
    Charles
Function:
    Reading image of Truevision TARGA file, TGA, VDA, ICB VST.
Input:
    -info: filename or file-header.
Output:
    -I, Map: the result of reading image.
%}
function [I, Map] = readTgaImage(info)
if(~isstruct(info))
